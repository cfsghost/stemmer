	...
	self.getObjects(function(err, objects) {
		...
		for (var objPath in objects) {
			...
			if (objPath.search('/org/freedesktop/UDisks2/drives') == 0) {
				...
				drives.push(drive);
				/*
				console.log('getDrives on ');
				console.log(drive);
				{ _disk:
				   { dbus: { _dbus: [Object], signalHandlers: [Object] },
					 systemBus:
					  { dbus: [Object],
						name: 'system',
					 ...
					 manager:
					  { bus: [Object],
						serviceName: 'org.freedesktop.UDisks2',
						objectPath: '/org/freedesktop/UDisks2',
						interfaceName: 'org.freedesktop.DBus.ObjectManager',
						object: [Object],
						GetManagedObjects: [Object],
						_events: [Object] },
					 _events: { BlockDeviceAdded: [Function], BlockDeviceRemoved: [Function] } },
				  objectPath: '/org/freedesktop/UDisks2/drives/SD08G_0x70d1e3f8',
				  id: 'SD08G_0x70d1e3f8',
				  serial: 'SD08G_0x70d1e3f8',
				  model: '',
				  vendor: '',
				  wwn: '',
				  revision: '',
						   ...
						   { dbus: { _dbus: [Object], signalHandlers: [Object] },
							 ...
							 manager:
							  { bus: [Object],
								...
								_events: [Object] },
							 _events: { BlockDeviceAdded: [Function], BlockDeviceRemoved: [Function] } },
						  objectPath: '/org/freedesktop/UDisks2/drives/LITEONIT_LCT_128M3S_002230107153',
						  id: 'LITEONIT-LCT-128M3S-002230107153',
						  serial: '002230107153',
						  model: 'LITEONIT LCT-128M3S',
						  vendor: '',
